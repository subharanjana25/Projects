...
const Electronics = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/electronics')
  ...
  const handleAddToCart = (productId) => {
    ...
    axios.post(
      ...
      { userId, productId, quantity: 1, category: 'electronics' }, // Ensure the category matches the product type
      {
      ...
      >
        {selectedProduct && (
          <div className="modal-content">
            ...
            <p><b>Specifications:</b> {selectedProduct.specifications}</p>
